...
const routes = [
    ...
    {
        path: 'image-modal',
        loadChildren: () => Promise.all(/*! import() | image-modal-image-modal-module */[__webpack_require__.e("common"), __webpack_require__.e("image-modal-image-modal-module")]).then(__webpack_require__.bind(null, /*! ./image-modal/image-modal.module */ "./src/app/image-modal/image-modal.module.ts")).then(m => m.ImageModalPageModule)
    }
];
...
/* harmony import */ var _imgsearch_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./imgsearch.service */ "./src/app/imgsearch.service.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            _imgsearch_service__WEBPACK_IMPORTED_MODULE_10__["ImgSearchService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ImgSearchService", function() { return ImgSearchService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let ImgSearchService = class ImgSearchService {
    constructor(http) {
        this.http = http;
    ...
    getRandomImg() {
        return this.http.get(`https://api.unsplash.com/photos/random?client_id=${this.APIKEY}`);
    }
    getImg() {
        return this.http.get(`https://api.unsplash.com/photos/?page=${this.page}&per_page=${this.per_page}&client_id=${this.APIKEY}`);
    }
    searchImg(query, offset) {
        if (query == '') {
            return this.http.get(`https://api.unsplash.com/photos/?page=${offset}&per_page=${this.per_page}&client_id=${this.APIKEY}`);
        }
        else {
            return this.http.get(`https://api.unsplash.com/search/photos?client_id=${this.APIKEY}&query=${query}&page=${offset}&per_page=${this.per_page}`);
        }
    }
};
ImgSearchService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
ImgSearchService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
module.exports = __webpack_require__(/*! D:\Projects\picbin\src\main.ts */"./src/main.ts");
